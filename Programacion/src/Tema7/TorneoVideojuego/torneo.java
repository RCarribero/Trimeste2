...
class torneo {
    ...
    String getCodigoTorneo() {
        return codigoTorneo;
    }
    void setCodigoTorneo(String codigoTorneo) {
    ...
    List<equipo> getListEquipos() {
        return ListEquipos;
    }
    void setListEquipos(equipo equipo) {
    ...
    Map<equipo, Integer> getPuntuaciones() {
    ...
    void setPuntuaciones(equipo equipo, int puntuacion) {
        puntuaciones.put(equipo, puntuacion);
    }
    void aumentarPuntuacion(equipo equipo, int puntuacion) {
